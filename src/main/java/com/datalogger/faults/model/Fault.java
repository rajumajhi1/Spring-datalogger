...
public class Fault {
    ...
    public int hashCode() {
        ...
        result = result * PRIME + ($faultNo == null ? 43 : ((Object)$faultNo).hashCode());
        ...
        result = result * PRIME + ($dlYear == null ? 43 : ((Object)$dlYear).hashCode());
        Integer $noticedTime = this.getNoticedTime();
        result = result * PRIME + ($noticedTime == null ? 43 : ((Object)$noticedTime).hashCode());
        Integer $noticedYear = this.getNoticedYear();
        result = result * PRIME + ($noticedYear == null ? 43 : ((Object)$noticedYear).hashCode());
        Integer $cleared = this.getCleared();
        result = result * PRIME + ($cleared == null ? 43 : ((Object)$cleared).hashCode());
        Integer $clearedYear = this.getClearedYear();
        result = result * PRIME + ($clearedYear == null ? 43 : ((Object)$clearedYear).hashCode());
        Integer $category = this.getCategory();
        result = result * PRIME + ($category == null ? 43 : ((Object)$category).hashCode());
        Integer $classification = this.getClassification();
        result = result * PRIME + ($classification == null ? 43 : ((Object)$classification).hashCode());
        Integer $clientId = this.getClientId();
        result = result * PRIME + ($clientId == null ? 43 : ((Object)$clientId).hashCode());
        ...
        result = result * PRIME + ($rPersonId == null ? 43 : $rPersonId.hashCode());
        String $cPersonId = this.getcPersonId();
        result = result * PRIME + ($cPersonId == null ? 43 : $cPersonId.hashCode());
        ...
        result = result * PRIME + ($faultPseudoType == null ? 43 : $faultPseudoType.hashCode());
        String $cktFileName = this.getCktFileName();
        result = result * PRIME + ($cktFileName == null ? 43 : $cktFileName.hashCode());
        String $cktStatFileName = this.getCktStatFileName();
        result = result * PRIME + ($cktStatFileName == null ? 43 : $cktStatFileName.hashCode());
        String $linkMessage = this.getLinkMessage();
        result = result * PRIME + ($linkMessage == null ? 43 : $linkMessage.hashCode());
        String $faultStatus = this.getFaultStatus();
        result = result * PRIME + ($faultStatus == null ? 43 : $faultStatus.hashCode());
        ...
        result = result * PRIME + ($fltReason == null ? 43 : $fltReason.hashCode());
        String $remarks = this.getRemarks();
        result = result * PRIME + ($remarks == null ? 43 : $remarks.hashCode());
        String $eFltInfo = this.geteFltInfo();
        result = result * PRIME + ($eFltInfo == null ? 43 : $eFltInfo.hashCode());
        String $trainNo = this.getTrainNo();
        result = result * PRIME + ($trainNo == null ? 43 : $trainNo.hashCode());
        String $asmName = this.getAsmName();
        result = result * PRIME + ($asmName == null ? 43 : $asmName.hashCode());
        String $reasonDelayOrNotSet = this.getReasonDelayOrNotSet();
        result = result * PRIME + ($reasonDelayOrNotSet == null ? 43 : $reasonDelayOrNotSet.hashCode());
        return result;
    }
}
